...
// a function to listen for messahes on the MailerChan
...
func (m *Mail) sendMail(msg Message, errorChan chan error) {
	...
	server.Encryption = m.getEncryptionMessage(m.Encryption)
...
func (m *Mail) getEncryptionMessage(e string) mail.Encryption {
	switch e {
	case "tls":
